...
# save
write.csv2(clinical.results, paste0("results/phase_valence_PTSD_clinical", date(),".csv"))
ggsave(paste0("results/phase_valence_PTSD_clinical", date(),".jpg"),
...
# save
write.csv2(preclinical.results, paste0("results/phase_valence_PTSD_preclinical", date(),".csv"))
ggsave(paste0("results/phase_valence_PTSD_preclinical", date(),".jpg"),
