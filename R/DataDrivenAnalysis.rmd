...
# select top half most important variables
...
```{r}
ggarrange(
 var.imp.plot.clinical + labs(title = "Clinical data") + theme_pubr(base_size = 8),
 var.imp.plot.preclinical + labs(title = "Preclinical data") + theme_pubr(base_size = 8) + rremove("ylab"),
