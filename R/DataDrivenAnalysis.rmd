...
data %>% select(subject, #nPTSD, nHC,
  ...
  mutate(
    ...
    cuectx=factor(cuectx, levels=c("cue", "cuecue", "cuecontext", "context"),
...
```{r}
jpeg(file="results/metaCART.clinical.jpeg", height =3000, width = 3000, res=300, pointsize = 12)
plot(REtree.C)
dev.off()
```
...
```{r}
jpeg(file="results/metaCART.preclinical.jpeg", height = 3000, width = 3000, res=300, pointsize = 12)
plot(REtree.P)
dev.off()
```
...
{jpeg(file="results/metaforest_PD_clinical.jpeg", height = 2000, width = 3000, res=300) # Higher quality output
  grid.draw(PD.clinical)
  dev.off()}
```
...
{jpeg(file="results/metaforest_PD_clinical_metaCARTfollowup.jpeg", height = 1000, width = 2500, res=300) # Higher quality output
# {jpeg(file="results/metaforest_PD_clinical.jpeg", height = 3000, width = 2000, res=300) # Higher quality output
  grid.draw(PD.clinical.metacart)
  dev.off()}
```
...
{jpeg(file="results/metaforest_PD_preclinical.jpeg", height = 3000, width = 3000, res=300) # Higher quality output
  grid.draw(PD.preclinical)
  dev.off()}
```
...
{jpeg(file="results/metaforest_PD_preclinical_metaCARTfollowup.jpeg", height = 1000, width = 2500, res=300) # Higher quality output
  grid.draw(PD.preclinical.metacart)
  dev.off()}
```
